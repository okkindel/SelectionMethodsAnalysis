...
def make_experiment(file, set, elements):
    ...
    make_simple_summary('NO SELECTION', set, X, accuracy, maririx_rev, ['all'], 100)
    file.write(get_string_summary('NO SELECTION', set, X, accuracy, maririx_rev, ['all'], 100))
    
    for iterator in range (1, 5):
        percent = 100 / 5 * iterator
        feat_num = math.floor(X.shape[1] / 5 * iterator)
        ...
        maririx_rev = reverseMatrix(matrix)
        make_simple_summary('ANOVA', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start)
        file.write(get_string_summary('ANOVA', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start))
        ...
        accuracy, matrix = get_average_score(X_Fit, y)
        maririx_rev = reverseMatrix(matrix)
        make_simple_summary('RELIEF', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start)
        file.write(get_string_summary('RELIEF', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start))
        ...
        accuracy, matrix = get_average_score(X_Fit, y)
        maririx_rev = reverseMatrix(matrix)
        make_simple_summary('INFORATION GAIN', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start)
        file.write(get_string_summary('INFORATION GAIN', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start))
        ...
        accuracy, matrix = get_average_score(X_Fit, y)
        maririx_rev = reverseMatrix(matrix)
        make_simple_summary('CHI SQUARE', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start)
        file.write(get_string_summary('CHI SQUARE', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start))
        ...
        accuracy, matrix = get_average_score(X_Fit, y)
        maririx_rev = reverseMatrix(matrix)
        make_simple_summary('CORRELATION COEF', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start)
        file.write(get_string_summary('CORRELATION COEF', set, X_Fit, accuracy, maririx_rev, scores, percent, end - start))
...
file = open('percent_' + DATA_PART + '.csv', 'w')
