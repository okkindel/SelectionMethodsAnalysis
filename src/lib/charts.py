...
def makeMeanChart(df):
    ...
    axes[2].grid()
    axes[2].bar(height=np.mean(no['recall']), edgecolor='black', color='red', x="NO SELECTION")
    axes[2].bar(height=np.mean(an['recall']), edgecolor='black', color='azure', x="ANOVA")
    axes[2].bar(height=np.mean(re['recall']), edgecolor='black', color='aqua', x="RELIEF")
    axes[2].bar(height=np.mean(ig['recall']), edgecolor='black', color='grey', x="INFORATION GAIN")
    axes[2].bar(height=np.mean(cs['recall']), edgecolor='black', color='teal', x="CHI SQUARE")
    axes[2].bar(height=np.mean(cc['recall']), edgecolor='black', color='aquamarine', x="CORRELATION COEF")
