...
### Ubezpieczenia zdrowotne {#sec:hics}
...
Table: Porównanie średniej liczby wybranych cech oraz odchylenia ćwiartkowego wyników dla każdej z metod, dla części zbiorów (stopień niezbalansowania pomiędzy 1:1.5 a 1:9). {#tbl:mean_best_feats_part_1}
