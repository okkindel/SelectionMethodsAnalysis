from lib.feature_selection import calculatePrecision, calculateFPR_TPR_TNR, calculateF1
...
def make_summary(X_Fit, X, accuracy, accuracy_no, matrix, matrix_no):
    ...
    print(bcolors.YELLOW + 'FPT_TPR: '          + str(calculateFPR_TPR_TNR(matrix_no))  + bcolors.ENDC)
    ...
    print(bcolors.GREEN + 'FPT_TPR: '          + str(calculateFPR_TPR_TNR(matrix))  + bcolors.ENDC)
